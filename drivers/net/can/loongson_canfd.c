 ...
 * Return: 1 when frame is passed to the network layer or system is out of free SKBs
 *         temporally and left code to resolve SKB allocation later, -%EAGAIN in a case
 *         of empty Rx FIFO.
 */
